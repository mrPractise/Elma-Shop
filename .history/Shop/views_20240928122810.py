...
def thank_you(request):
    ...
    whatsapp_url = generate_whatsapp_url(pending_order)
...
def complete_order(request):
    ...
    # Create PurchaseOrder and PurchaseOrderItems
    ...
    return redirect('cartpage')  # or wherever you want to redirect after completing the orde
