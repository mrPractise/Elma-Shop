...
class PurchaseOrderAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('order_number', 'name', 'address', 'total_amount', 'created_at', 'item_count')
    
    fieldsets = (
        (None, {
            'fields': ('order_number', 'name', 'address', 'total_amount', 'created_at', 'status', 'item_count')
        }),
    )
