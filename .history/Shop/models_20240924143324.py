...
class PurchaseOrder(models.Model):
    ...
    def generate_order_number():
        ...
        max_sequence = PurchaseOrder.objects.filter(created_at__gte=today_start).count()
        ...
        return f"{day_abbr}-{sequence_str}-{date_str}"
...
class ShippingLocation(models.Model):
    ...
    def __str__(self):
        return f"{self.name} (Ksh. {self.shipping_cost})"
