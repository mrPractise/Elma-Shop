    ...
    try:
        ...
        for item in items:
            ...
            try:
                ...
                response = requests.get(image_url, timeout=30, verify=True)  # Increased timeout
                ...
                # Use a placeholder image or leave cell empty
        ...
        total_paragraph = Paragraph(f"Total Order Amount: {total_amount}", ParagraphStyle(name='TotalAmount', parent=normal_style, backColor=colors.yellow))
