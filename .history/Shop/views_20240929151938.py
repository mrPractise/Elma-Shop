...
# Local imports
from .models import Cart, CartItem, Product, Category, Subcategory, HeroImage, PurchaseOrder, ShippingLocation
...
def checkout(request):
    """
    Handle the checkout process, including form submission and order creation.
    """
    cart = get_or_create_cart(request)
    cart_items = cart.items.all().select_related('product')
...
def thank_you(request):
    ...
    whatsapp_message = f"New order received. View order details: {pdf_url}"
