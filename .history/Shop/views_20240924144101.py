...
from Shop.models import Cart, CartItem, Product, Category, Subcategory, HeroImage,PurchaseOrder, PurchaseOrderItem
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            shipping_cost = location.shipping_cost if location else 0
            ...
            # If the form is not valid, we'll render the page again with the form errors
            context = {
                'page': 'checkout',
                'form': form,
                'cart_items': cart_items,
