...
default_origins = 'https://elma-shop-production.up.railway.app'
CSRF_TRUSTED_ORIGINS = os.environ.get('CSRF_TRUSTED_ORIGINS', default_origins).split(',')
...
# Database
if os.environ.get('RAILWAY_ENVIRONMENT') is None:  # Assuming Railway sets this or a similar environment variable
    DATABASES = {
        'default': {
