document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateCartDisplay(productId, quantity, totalPrice, cartTotal) {
    ...
    if (cartItem) {
      ...
      if (quantitySpan) quantitySpan.textContent = quantity;
      if (itemTotal) itemTotal.textContent = `${totalPrice}`;
    }
    ...
    if (subtotalElement) subtotalElement.textContent = `${cartTotal}`;
  }
